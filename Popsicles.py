...
brothers and sisters. If you have enough left in the box to give them each an
 even amount you should go for it! If not, they will fight over them, and
  you should eat them yourself later.

Task
Given the number of siblings that you are giving popsicles to, determine if 
you can give them each an even amount or if you shouldn't mention the popsicles 
at all.
...
popsicles = int(input("Enter popsicles : "))

def sharePop(siblings,popsicles):
	eachShare = popsicles%siblings
	if eachShare == 0:
		print("give away")
	elif eachShare != 0:
		print("eat them yourself")
		
sharePop(siblings, popsicles)